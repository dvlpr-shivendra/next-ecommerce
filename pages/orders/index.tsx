        ...
        {orders.map((order) => (
          <li key={order.id} className="mb-6">
            <Link href={`/orders/${order.id}`}>
              <div className="flex items-center justify-between p-6 border border-accent border-dashed hover:border-solid hover:shadow-lg hover:scale-[1.005] transition duration-500 ease-out">
